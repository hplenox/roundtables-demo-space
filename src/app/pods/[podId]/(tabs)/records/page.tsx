        ...
        <div className="flex items-center gap-2 flex-1 min-w-[200px] justify-end">
          <div className="relative flex-1 max-w-[220px]">
            ...
            <input
              ...
              className="w-full pl-8 pr-2.5 py-2 rounded-lg border border-slate-200 bg-white text-[12.5px] focus:outline-none focus:ring-2 focus:ring-[#00b8a9]/30"
            />
          </div>
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3 py-2 rounded-lg bg-[#00b8a9] text-white text-[12.5px] font-semibold hover:bg-[#00a89a] transition-colors"
          >
          ...
          {awaiting.map((r) => (
            <div key={r.id} className="flex items-center justify-between gap-3 px-4 py-3.5 border-b border-slate-50 last:border-0">
              ...
              <div className="shrink-0 flex items-center gap-3">
                ...
                {r.confirmation === "sent" ? (
                  <button onClick={() => resendRecord(r.id)} className="text-[12px] font-semibold text-[#00897b] hover:underline">Resend</button>
                ) : (
    ...
    <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm">
      <div className="flex items-start justify-between gap-3 flex-wrap mb-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="inline-flex items-center gap-1.5 px-3 py-2 rounded-lg bg-[#00b8a9] text-white text-[12px] font-semibold hover:bg-[#00a89a] transition-colors">
      ...
      {record.aiSummary && (
        <div className="flex items-start gap-2.5 p-3.5 rounded-xl bg-[#00b8a9]/[0.06] border border-[#00b8a9]/15 mb-4">
          <Sparkles size={14} className="text-[#00897b] shrink-0 mt-0.5" />
          <p className="text-[12.5px] text-slate-700 leading-snug">
            <span className="font-bold text-[#00897b]">Members say — </span>
            {record.aiSummary}
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
        ...
        <Field label="Website" value={record.website ? <a href={`https://${record.website}`} target="_blank" rel="noreferrer" className="inline-flex items-center gap-1 text-[#00897b] hover:underline">{record.website}<ExternalLink size={10} /></a> : "—"} />
      ...
      <div>
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="flex-1 px-3 py-2 rounded-lg border border-slate-200 text-[12.5px] focus:outline-none focus:ring-2 focus:ring-[#00b8a9]/30"
            onKeyDown={(e) => e.key === "Enter" && onAddNote()}
          />
          <button onClick={onAddNote} className="text-[12px] font-semibold text-white bg-[#00b8a9] hover:bg-[#00a89a] px-3 py-2 rounded-lg transition-colors">Add note</button>
