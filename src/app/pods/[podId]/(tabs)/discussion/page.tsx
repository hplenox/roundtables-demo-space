      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-4 shadow-sm">
        ...
        {showPoll && (
          <div className="mb-3 p-3 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
            ...
            <div className="flex justify-end gap-2 pt-1">
              ...
              <button onClick={handlePostPoll} className="text-[12px] font-semibold text-white bg-[#4361ee] hover:bg-[#3d58d9] px-3 py-1.5 rounded-lg transition-colors">Post poll</button>
            </div>
          </div>
        )}
        ...
        <div className="flex items-center justify-between pt-2 border-t border-slate-100">
          ...
          <button
            onClick={handlePost}
            disabled={!body.trim()}
            className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-lg bg-[#4361ee] text-white text-[12.5px] font-semibold hover:bg-[#3d58d9] disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
          >
            <Send size={13} /> Post
          </button>
        </div>
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="flex items-center gap-4 mt-3">
            <button
              ...
              className={`inline-flex items-center gap-1.5 text-[12px] font-medium transition-colors ${post.liked ? "text-[#3147af]" : "text-slate-400 hover:text-slate-600"}`}
            >
          ...
          {showReply && (
            <div className="flex items-center gap-2 mt-3">
              ...
              />
              <button onClick={submitReply} className="text-[12px] font-semibold text-white bg-[#4361ee] hover:bg-[#3d58d9] px-3 py-1.5 rounded-lg transition-colors">Send</button>
            </div>
          )}
        </div>
      </div>
  ...
  return (
    <div className="mt-3 rounded-xl border border-slate-200 overflow-hidden">
      <div className="flex items-center justify-between px-3.5 py-2.5 bg-slate-50 border-b border-slate-200">
        <p className="text-[12.5px] font-bold text-slate-700 flex items-center gap-1.5"><CalendarPlus size={13} className="text-[#3147af]" /> {poll.question}</p>
          ...
          return (
            ...
            >
              ...
              <span className="relative flex items-center gap-2 text-[12.5px] text-slate-700 font-medium">
                ...
                {mine && <span className="text-[10px] font-bold text-[#3147af]">(your vote)</span>}
              </span>
      ...
      <div className="flex items-center gap-3 px-3.5 py-2.5 bg-white">
        {poll.createdEventId ? (
          ...
          <button onClick={onCreateEvent} className="inline-flex items-center gap-1.5 text-[12px] font-semibold text-white bg-[#4361ee] hover:bg-[#3d58d9] px-3 py-1.5 rounded-lg transition-colors">
