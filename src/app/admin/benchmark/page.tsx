...
function ScoreBadge({ score }: { score: number }) {
  const color =
    ...
    score >= 6.5 ? "bg-[#4361ee]/8 text-[#3147af] border-[#4361ee]/25" :
...
function MiniBar({ score }: { score: number }) {
  ...
  const bg = score >= 8 ? "#10b981" : score >= 6.5 ? "#4361ee" : score >= 5 ? "#f59e0b" : "#ef4444";
  return (
            ...
            <div className="px-3 pt-2 pb-1">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-6 pr-2 py-1 text-[11px] border border-slate-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-[#4361ee]/30"
                />
              </div>
            </div>
          )}
    ...
    return (
      <div className="flex items-center gap-1 group">
        ...
        >
          {label}
          {isActive
            ? (sortAsc ? <ArrowUp size={9} className="text-[#4361ee]" /> : <ArrowDown size={9} className="text-[#4361ee]" />)
        ...
        {hasFilter && <span className="w-1.5 h-1.5 rounded-full bg-[#4361ee] shrink-0" />}
      </div>
    );
  }
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          <h2 className="text-lg font-bold text-slate-900 flex items-center gap-2">
            <BarChart3 size={18} className="text-[#4361ee]" />
            LPI Benchmark
          </h2>
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <div className="relative flex-1 min-w-[180px] max-w-xs">
              ...
              <input
                ...
                className="w-full pl-7 pr-3 py-1.5 text-[12px] border border-slate-200 rounded-lg bg-white text-slate-800 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-[#4361ee]/30 focus:border-[#4361ee]"
              />
            </div>
            ...
            <div className="flex items-center gap-3 px-4 py-2.5 bg-[#0f1923] rounded-xl border border-white/10">
              ...
              <div className="flex items-center gap-2 ml-auto">
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#4361ee]/20 border border-[#4361ee]/30 text-[#4361ee] text-[12px] hover:bg-[#4361ee]/30 transition-colors"
                >
                      ...
                      <td className="px-1 py-3 w-6 text-center">
                        {entry.historicalScores.length > 0 ? (
                          <button
                            ...
                            className="text-slate-300 hover:text-[#4361ee] transition-colors"
                          >
                        ...
                        {editingClass === entry.id ? (
                          <div className="flex items-center gap-1.5">
                            <select
                              ...
                              className="text-[11px] border border-[#4361ee]/40 rounded-lg px-2 py-1 bg-white focus:outline-none focus:ring-2 focus:ring-[#4361ee]/30"
                            >
                          ...
                          <button
                            ...
                            className="flex items-center gap-1 text-[11.5px] text-slate-600 bg-slate-50 border border-slate-200 px-2 py-1 rounded-lg hover:border-[#4361ee]/40 hover:bg-[#4361ee]/4 transition-colors group"
                          >
                            {entry.assetClass}
                            <ChevronDown size={9} className="text-slate-300 group-hover:text-[#4361ee] transition-colors" />
                          </button>
                        ) : (
                          <button
                            onClick={() => setEditingClass(entry.id)}
                      ...
                      <tr key={`${entry.id}-history`} className="bg-slate-50/70 border-b border-slate-100">
                        <td colSpan={9} className="px-12 py-3">
                          <div className="flex items-center gap-2 mb-2.5">
                            <History size={11} className="text-[#4361ee]" />
                          ...
                          <div className="flex items-start gap-5 flex-wrap">
                            ...
                            <div className="flex flex-col items-center gap-1 border-l-2 border-[#4361ee]/20 pl-5">
                              <ScoreBadge score={entry.lpiScore} />
                              <span className="text-[10px] font-semibold text-[#3147af]">2026 (current)</span>
                            </div>
                          </div>
                        </td>
                      </tr>
        ...
        <div className="space-y-8 pt-3">
          <div className="flex items-center gap-3 text-[12px] text-slate-500 flex-wrap">
            <span className="flex items-center gap-1.5 bg-white border border-slate-200 px-3 py-1.5 rounded-lg shadow-sm">
              <TrendingUp size={11} className="text-[#4361ee]" />
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-3.5 py-1.5 rounded-lg text-[12px] font-semibold border transition-all duration-150 ${
                      focusedGroupKey === g.key
                        ...
                        : "bg-white border-slate-200 text-slate-600 hover:border-[#4361ee]/40 hover:text-[#3147af]"
                    }`}
                  >
                    {g.label}
                    <span
