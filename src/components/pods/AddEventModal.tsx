        ...
        {step === 1 ? (
          <>
                    ...
                    return (
                      <button
                        ...
                        className={`inline-flex items-center gap-1.5 px-3 py-2 rounded-lg text-[12.5px] font-semibold border-2 transition-colors ${
                          active ? "border-[#4361ee] bg-[#4361ee]/5 text-[#3650d4]" : "border-slate-200 text-slate-500 hover:border-slate-300"
                        }`}
                      >
            ...
            <div className="flex items-center justify-between gap-2 px-6 py-5 mt-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <button onClick={() => setStep(2)} className="px-4 py-2 rounded-lg bg-[#4361ee] text-white text-[13px] font-semibold hover:bg-[#3650d4] transition-colors">Continue</button>
              </div>
            </div>
          </>
        ) : (
          <>
            ...
            <div className="flex items-center justify-end gap-2 px-6 py-5 mt-2">
              ...
              <button onClick={handleCreate} className="px-4 py-2 rounded-lg bg-[#4361ee] text-white text-[13px] font-semibold hover:bg-[#3650d4] transition-colors">Create event</button>
            </div>
          </>
        )}
      </div>
