        ...
        {step === 1 ? (
          <>
            <div className="px-6 pt-5 space-y-4">
              ...
              <div className="grid grid-cols-3 gap-3">
                <div>
                  ...
                  <input type="date" value={date} onChange={(e) => setDate(e.target.value)} className="w-full px-3 py-2.5 rounded-lg border border-slate-200 text-[13px] focus:outline-none focus:ring-2 focus:ring-[#4361ee]/30" />
                </div>
                <div>
                  <label className="block text-[12px] font-medium text-slate-500 mb-1.5">Start</label>
                  <input value={start} onChange={(e) => setStart(e.target.value)} className="w-full px-3 py-2.5 rounded-lg border border-slate-200 text-[13px] focus:outline-none focus:ring-2 focus:ring-[#4361ee]/30" />
                </div>
                <div>
                  <label className="block text-[12px] font-medium text-slate-500 mb-1.5">End</label>
                  <input value={end} onChange={(e) => setEnd(e.target.value)} className="w-full px-3 py-2.5 rounded-lg border border-slate-200 text-[13px] focus:outline-none focus:ring-2 focus:ring-[#4361ee]/30" />
                </div>
              </div>
              <div>
                    ...
                    return (
                      <button
                        ...
                        className={`inline-flex items-center gap-1.5 px-3 py-2 rounded-lg text-[12.5px] font-semibold border-2 transition-colors ${
                          active ? "border-[#4361ee] bg-[#4361ee]/5 text-[#3147af]" : "border-slate-200 text-slate-500 hover:border-slate-300"
                        }`}
                      >
                ...
                <input
                  ...
                  className="w-full mt-2 px-3.5 py-2.5 rounded-lg border border-slate-200 text-[13.5px] focus:outline-none focus:ring-2 focus:ring-[#4361ee]/30 focus:border-[#4361ee]"
                />
              </div>
              <div>
            ...
            <div className="flex items-center justify-between gap-2 px-6 py-5 mt-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <button onClick={() => setStep(2)} className="px-4 py-2 rounded-lg bg-[#4361ee] text-white text-[13px] font-semibold hover:bg-[#3d58d9] transition-colors">Continue</button>
              </div>
            </div>
          </>
        ) : (
          <>
            ...
            <div className="flex items-center justify-end gap-2 px-6 py-5 mt-2">
              ...
              <button onClick={handleCreate} className="px-4 py-2 rounded-lg bg-[#4361ee] text-white text-[13px] font-semibold hover:bg-[#3d58d9] transition-colors">Create event</button>
            </div>
          </>
        )}
      </div>
