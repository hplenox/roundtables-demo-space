...
export const MOCK_SURVEYS: Survey[] = [
  ...
  // and Response Review all describe the same underlying survey cycles.
  {
    ...
    hostContact: "Diane Whitmore",
    startDate: "Jun 1, 2026",
    targetCloseDate: "Sep 30, 2026",
    status: "active",
    assetClasses: ["Private Equity", "Venture Capital"],
    privacyLevel: "Aggregate only",
    totalInvited: 34,
    submitted: 9,
    inProgress: 6,
    notStarted: 19,
    lastSubmission: "Aug 19, 2026",
    daysRemaining: 34,
    weeklyReportUrl: "#",
  },
  {
    id: "survey-2026-dei-macp",
    name: "2026 MACP Manager Diversity Survey",
    year: 2026,
    hostOrg: "MACP",
    hostContact: "Robert Aldrin",
    startDate: "Jun 15, 2026",
    targetCloseDate: "Nov 15, 2026",
    status: "active",
    assetClasses: ["Private Equity", "Infrastructure"],
    privacyLevel: "Full disclosure",
    totalInvited: 58,
    submitted: 22,
    inProgress: 14,
    notStarted: 22,
    lastSubmission: "Aug 18, 2026",
    daysRemaining: 80,
    weeklyReportUrl: "#",
  },
  {
    id: "survey-2026-dei-maryland",
    name: "2026 Maryland State Retirement Manager Survey",
    year: 2026,
    hostOrg: "Maryland State Retirement Agency",
    hostContact: "Renata Osei",
    startDate: "May 1, 2026",
    targetCloseDate: "Oct 15, 2026",
    status: "active",
    assetClasses: ["Private Equity", "Real Assets"],
    privacyLevel: "Full disclosure",
    totalInvited: 45,
    submitted: 10,
    inProgress: 12,
    notStarted: 23,
    lastSubmission: "Aug 24, 2026",
    daysRemaining: 49,
    weeklyReportUrl: "#",
  },
  {
    id: "survey-2026-esg-ilpa",
    name: "2026 ESG & Diversity Reporting",
    year: 2026,
    hostOrg: "ILPA",
    hostContact: "Marcus Bellweather",
    startDate: "May 15, 2026",
    targetCloseDate: "Oct 14, 2026",
    status: "active",
    assetClasses: ["Private Equity", "Private Credit", "Real Assets"],
    privacyLevel: "Aggregate only",
    totalInvited: 29,
    submitted: 3,
    inProgress: 5,
    notStarted: 21,
    lastSubmission: "Aug 1, 2026",
    daysRemaining: 48,
    weeklyReportUrl: "#",
  },
];
